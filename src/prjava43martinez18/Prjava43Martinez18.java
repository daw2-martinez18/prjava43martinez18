package prjava43martinez18; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
 import java.io.*;
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43Martinez18 extends Frame 
   ...
   public Prjava43Martinez18 () { 
      ...
      setTitle("nova finestra prjava43Martinez18");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43Martinez18();  // Let the construct do the job 
   } 
